...
public class LoginSecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity, AuthenticationSuccessHandler customAuthenticationSuccessHandler) throws Exception{
        ...
        httpSecurity.authorizeHttpRequests(configurer -> configurer
                .requestMatchers("/", "/index", "/login-directory/**", "/customers/create-customer", "/companies/create-company", "/categories/categories-list", "/static/**", "/css/**", "/images/**", "/index", "/home", "/sign-up", "products/products-list").permitAll()
